...
// Recorre los botones de editar y agrega un evento click a cada uno
...
// Cierra el cuadro modal al hacer clic en la "X"
const closeModal = document.querySelector('.close');
closeModal.addEventListener('click', function () {
  modal.style.display = 'none';
});

// Cierra el cuadro modal al hacer clic fuera de él
